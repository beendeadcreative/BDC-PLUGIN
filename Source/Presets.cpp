...
const std::vector<FactoryPreset>& getFactoryPresets()
{
    static const std::vector<FactoryPreset> presets = {
        // name                sustain root scale unpred  density size  spread sync  div mult genMix chRate chDepth chMix rFast rMix  dTime  dSync dDiv dMult  dFb   dMix  tape  outGain bpm    keyFollow
        ...
        { "Ghost Choir",       { true,  0,   4,    0.12f,  3.5f,  320.0f, 3.2f, false, 2,  2, 0.75f, 0.3f,  0.6f,  0.4f,  false, 0.50f, 520.0f, false, 2, 2, 0.40f, 0.30f, 15.0f, -2.0f, 90.0f, false } },
        ...
        { "Space Echo Dub",    { true,  9,   4,    0.15f,  2.5f,  180.0f, 1.8f, false, 3,  2, 0.2f,  0.6f,  0.2f,  0.15f, false, 0.20f, 400.0f, true,  2, 2, 0.60f, 0.45f, 35.0f, -2.0f, 100.0f, false } },
        ...
        { "Rhythmic Pulse",    { true,  9,   4,    0.30f,  6.0f,  120.0f, 1.0f, true,  4,  2, 0.6f,  0.6f,  0.25f, 0.2f,  false, 0.20f, 300.0f, true,  2, 2, 0.35f, 0.30f, 10.0f, 0.0f, 124.0f, false } },
        ...
        { "Glitch Radio Dub",  { true,  9,   4,    0.65f,  14.0f, 70.0f,  1.3f, false, 3,  2, 0.7f,  1.0f,  0.3f,  0.25f, true,  0.35f, 400.0f, true,  2, 2, 0.70f, 0.45f, 65.0f, -2.0f, 132.0f, false } },
