...
void applyFactoryPreset (juce::AudioProcessorValueTreeState& apvts, const FactoryPresetValues& v)
{
    ...
    setParamRaw (apvts, "delayReverse", v.delayReverse ? 1.0f : 0.0f);
...
const std::vector<FactoryPreset>& getFactoryPresets()
{
    static const std::vector<FactoryPreset> presets = {
        // name                sustain root scale unpred  density size  spread sync  div mult genMix chRate chDepth chMix rFast rMix  dTime  dSync dDiv dMult  dFb   dMix  tape  outGain bpm    keyFollow [taps tapSpread glue trigger reverse]
        ...
        { "Reverse Tide",      { true,  4,   3,    0.10f,  2.0f,  350.0f, 3.0f, false, 3,  2, 0.55f, 0.3f,  0.3f,  0.2f,  false, 0.35f, 550.0f, false, 2, 2, 0.45f, 0.40f, 15.0f, -1.0f, 90.0f, false, 1, 0.0f, 25.0f, false, true } },
