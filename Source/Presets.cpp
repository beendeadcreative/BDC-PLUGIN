...
const std::vector<FactoryPreset>& getFactoryPresets()
{
    static const std::vector<FactoryPreset> presets = {
        ...
        { "Broken Radio",      { true,  9,   1,    0.25f,  1.2f,  300.0f, 2.5f, false, 3,  2, 0.55f, 0.3f,  0.1f,  0.1f,  false, 0.05f, 350.0f, false, 2, 2, 0.20f, 0.15f, 95.0f, 2.0f,  90.0f  } },
        { "Haunted Music Box", { true,  2,   2,    0.15f,  2.0f,  400.0f, 3.5f, false, 3,  2, 0.7f,  0.15f, 0.8f,  0.5f,  false, 0.60f, 650.0f, false, 2, 2, 0.50f, 0.35f, 25.0f, -2.0f, 76.0f  } },
        { "Wobble Cassette",   { true,  9,   4,    0.20f,  3.0f,  220.0f, 2.0f, false, 3,  2, 0.4f,  1.8f,  0.9f,  0.5f,  false, 0.20f, 400.0f, true,  7, 2, 0.75f, 0.40f, 70.0f, -1.0f, 100.0f } },
        { "Alien Transmission",{ true,  6,   2,    0.90f,  10.0f, 40.0f,  1.0f, true,  5,  2, 0.9f,  2.2f,  0.7f,  0.4f,  true,  0.50f, 150.0f, false, 2, 2, 0.40f, 0.30f, 5.0f,  -3.0f, 140.0f } },
        { "Church Basement",   { true,  4,   1,    0.10f,  1.8f,  450.0f, 3.8f, false, 3,  2, 0.65f, 0.25f, 0.4f,  0.3f,  false, 0.75f, 800.0f, false, 2, 2, 0.60f, 0.40f, 8.0f,  -2.0f, 68.0f  } },
        { "Chipmunk Grain",    { true,  0,   3,    0.60f,  22.0f, 45.0f,  0.8f, false, 3,  2, 0.8f,  0.8f,  0.3f,  0.2f,  false, 0.10f, 140.0f, false, 2, 2, 0.20f, 0.20f, 0.0f,  -4.0f, 150.0f } },
        { "Sunken Ship",       { true,  1,   1,    0.10f,  1.2f,  480.0f, 4.0f, false, 3,  2, 0.7f,  0.15f, 0.5f,  0.4f,  false, 0.50f, 1100.0f, false, 2, 2, 0.65f, 0.40f, 60.0f, -3.0f, 58.0f  } },
        { "Glitch Radio Dub",  { true,  9,   4,    0.65f,  14.0f, 70.0f,  1.3f, false, 3,  2, 0.7f,  1.0f,  0.3f,  0.25f, true,  0.35f, 400.0f, true,  2, 2, 0.70f, 0.45f, 65.0f, -2.0f, 132.0f } },
        { "Nightmare Carousel",{ true,  11,  2,    0.45f,  3.5f,  260.0f, 2.2f, false, 3,  2, 0.6f,  0.35f, 1.0f,  0.6f,  false, 0.55f, 420.0f, false, 2, 2, 0.40f, 0.30f, 30.0f, -2.0f, 84.0f  } },
        { "Space Dust",        { true,  7,   3,    0.05f,  0.8f,  500.0f, 4.0f, false, 3,  2, 0.5f,  0.1f,  0.6f,  0.4f,  false, 0.65f, 1400.0f, false, 2, 2, 0.55f, 0.35f, 12.0f, -3.0f, 60.0f  } },
    };
